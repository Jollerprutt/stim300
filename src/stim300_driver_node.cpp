...
int main(int argc, char **argv) {
  ...
  ros::Publisher imuSensorPublisher =
      node.advertise<sensor_msgs::Imu>(imu_output, 1000);
  ...
  try {
    ...
    while (ros::ok()) {
      ...
      case Stim300Status::NEW_MEASURMENT: {
        ...
        // gravity; stim300msg.linear_acceleration.y = driver_stim300.getAccY()
        // * gravity; stim300msg.linear_acceleration.z =
        // driver_stim300.getAccZ() * gravity; stim300msg.angular_velocity.x =
        // driver_stim300.getGyroX(); stim300msg.angular_velocity.y =
        // driver_stim300.getGyroY(); stim300msg.angular_velocity.z =
        ...
        Eigen::Quaterniond orientation =
            estimate_orientation(incl_acceleration);
